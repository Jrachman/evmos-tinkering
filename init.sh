...
echo "trick retreat teach soup pact shrimp dwarf midnight duty melody shop pen lumber crop impulse thing witness voice alter summer useful dizzy strong member" | evmosd keys add $KEY --recover
