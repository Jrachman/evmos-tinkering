...
echo "hand popular crisp vote coach clock rather leisure brand neck wash hawk math mistake illegal water outer include casual unaware maple pretty document super" | evmosd keys add $KEY --recover
